        ...
        <?php      
          foreach($data1 as $row3){
              echo"<tr>
                ...
                echo"	
                <th><a class='btn btn-outline-primary' href='download.php?token=".md5(session_id())."&data=".md5($fid)."&fname=".$row3['tx_arquivo']."&doctype=".$row3['tx_documento']."&relative=".$data[0]['tx_nome']."&type=funcionarios'><i class='nav-icon cui-cloud-download'></i> Download</a><th>
            </tr>";	  
